...
new Vue({
  ...
  methods: {
    ...
    searchCake: function() {
      this.$http.get('/api/cake/seasonal/search?search='+this.search).then((response) => {
        this.$set('cakes', response.data.data.data);
        this.$set('pagination', response.data.pagination);
      });
    },
    getVueItems: function(page) {
      this.$http.get('/api/cake/seasonal?page='+page).then((response) => {
        this.$set('cakes', response.data.data.data);
        this.$set('pagination', response.data.pagination);
      });
    },
